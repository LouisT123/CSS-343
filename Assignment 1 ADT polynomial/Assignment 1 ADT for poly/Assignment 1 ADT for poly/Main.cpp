...
int main() {
	...
	*/
	...
	//use set coeff here to concadinate
	...
	int coeff = D.getCoeff(0); //tested with 7 gave me 5, we good!
	cout << "coeff of subscript 0 of D is: " << coeff << endl;
	cout << "Doing getCoeff for term -20000" << endl; //handles outofrange, good!
